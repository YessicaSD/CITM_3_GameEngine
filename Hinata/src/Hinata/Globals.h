...
#ifdef HINA_PLATFORM_WINDOWS
	#ifdef HINA_BUILD_DLL
		#define HINA_API _declspec(dllexport)
	#else
		#define HINA_API _declspec(dllimport)
	#endif // HINA_BUILD_DLL
#else
	#error Hinata engine only supports Windows
#endif