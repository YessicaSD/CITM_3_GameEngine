...
//TODO (look at the rotate method)
// Return a vector representing the euler angles in which the primitive has been rotated (more understandable)
//btVector3 Primitive::GetRotation() {
//}
...
{
	LOG("Sphere render not implemented.");
